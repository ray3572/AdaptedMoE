...
from models.simplenet.discriminator import Discriminator
from models.simplenet.init_dataloader import init_dataloader
from models.simplenet.patch_maker import PatchMaker
from models.simplenet.preprocessing import Preprocessing, Aggregator, RescaleSegmentor
from models.simplenet.projection import Projection
from pretrain_backbone.aggregator import (NetworkFeatureAggregator_spark,
...
class SimpleNet(torch.nn.Module):
    def __init__(self, config, device):
        ...
        self.raw_feature_queue = mp.Queue(maxsize=1)
    ...
    def load_spark(
        ...
        feature_aggregator = NetworkFeatureAggregator_spark(
    ...
    def _predict(self, images):
        ...
        with torch.no_grad():
            ...
            # print("pred mask shape ",masks[0].shape)
